...
//	$rcp_add_ons_page       = add_submenu_page( 'rcp-members', __( 'Add-ons', 'rcp' ), __( 'Add-ons', 'rcp' ), 'rcp_view_members', 'rcp-add-ons', 'rcp_add_ons_admin', 10 );
	...
	$restrict_content_pro_welcome_page  = add_submenu_page( null, __( 'Welcome', 'restrict-content'), __( 'Welcome', 'restrict-content' ), 'manage_options', 'restrict-content-welcome', 'rc_welcome_page_redesign' );
