	...
	if ( ! get_option( 'dismissed-restrict-content-upgrade-notice', false ) ) {
        ...
        <div class="notice restrict-content-upgrade-notice notice-info is-dismissible">
            <p>
				<?php
				printf(
					__( 'Restrict Content 3.0 is here with powerful new features for memberships and content access. <a target="_blank" href="%s">See What\'s New →</a>', 'restrict-content' ),
